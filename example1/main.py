#!/usr/bin/env python3
"""
main.py — Entry point for Example 1: Cat vs Dog CNN Classifier.
...
def show_menu() -> int:
    console.print()
    t = Table(border_style="blue", show_header=False, min_width=55, padding=(0, 2))
...
def flow_inference(cfg: dict):
    ...
    console.print("      cat/  *.jpg")
    console.print("      dog/  *.jpg")
    console.print()
...
# ═══════════════════════════════════════════════════════════════════════════════
def main():
    parser = argparse.ArgumentParser(description="Example 1 — Cat vs Dog CNN")
